...
export function useSiteSettings() {
    ...
    return {
        ...
        viber: getViberLink(settings.social_viber_number), // Changed to expect number
        messenger: getMessengerLink(settings.social_messenger_user), // New field for username
        facebookPageId: settings.social_facebook_page_id, // New field for Page ID
